TITLE Voltage sensor protein VSFP2.3

COMMENT
Model calculates the displacement current and fluorescence response produced by the voltage-sensing domain in VSFP2.3
Kinetic parameters from least-square fits to experimental data provided by Alica Lundby (sensing currents) and Hiroki Mutoh (fluoresence data) of VSFP2.3 expressed in PC12 cells
...
PARAMETER {
	...
	S2ipONzero = 2.5 (1/ms)
	S2ipOFFzero = 0.06 (1/ms)

	S12pONzero = 0.013 (1/ms)
	S12pOFFzero = 0.0016 (1/ms)

	S12nONzero = 1e-12 (1/ms)
	S12nOFFzero = 0.012 (1/ms)
	...
	deltaGateS2ni = 0.1 (1)		: location of the transition state in the reaction of S2n to S2i
	deltaGateS2ip = 0.25 (1)	: location of the transition state in the reaction of S2i to S2p
	deltaGateS12p = 0.75 (1)	: location of the transition state in the reaction of S1p to S2p
	deltaGateS12n = 0.9 (1)		: location of the transition state in the reaction of S1n to S2n
	...
	R2nONzero = 1e-12 (1/ms)
	R2nOFFzero = 0.07 (1/ms)

	deltaF = 0.05 (1)				: maximum fluoresence modulation
